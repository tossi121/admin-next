  ...
  return (
    <div className="d-flex align-items-center">
      ...
      {userDetails.dark_mode == false && (
        <Badge pill bg="" className="me-1  ms-2 badge-size badge-soft-danger">
          Disabled
        </Badge>
      )}
      {userDetails.dark_mode == true && (
        <Badge pill bg="" className="me-1 ms-2 badge-size  badge-soft-success">
          Enabled
        </Badge>
      )}
      ...
      <div className="d-flex align-items-center">
        ...
        <Badge pill bg="" className="me-1 badge-soft-info ms-3 badge-size">
