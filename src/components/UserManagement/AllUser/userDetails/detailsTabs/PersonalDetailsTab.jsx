      ...
      <Row>
        ...
        <Col lg={4} className="d-flex align-items-center">
          ...
          {userDetails.is_email_verify == false && (
            <Badge pill bg="success" className="me-1 mb-3 pb-1 badge-size badge-soft-danger">
              Not Verified
            </Badge>
          )}
          {userDetails.is_email_verify == true && (
            <Badge pill bg="danger" className="me-1 mb-3 pb-1 badge-size badge-soft-success">
              Verified
            </Badge>
          )}
        </Col>
