...
import { addBrokerData, updateBrokerData } from '_services/nifty_service_api';

function EditBrokerModal(props) {
  const { setShow, selectedId, enquiryListData } = props;
  ...
  async function handelTermsData() {
    ...
    const response = await updateBrokerData(params);
    if (response.result == 1) {
      const values = {
        overview_broker_name: response.data?.overview_broker_name,
        overview_year_of_incorporation: response.data?.overview_year_of_incorporation,
        overview_broker_phone: response.data?.overview_broker_phone,
        overview_exchanges_enabled: response.data?.overview_exchanges_enabled,
        overview_demat_nsdl_cdsl: response.data?.overview_demat_nsdl_cdsl,
        overview_broker_rating: response.data?.overview_broker_rating,
        overview_website: response.data?.overview_website,
        brokerage_equity: response.data?.brokerage_equity,
        brokerage_equity_futures: response.data?.brokerage_equity_futures,
        brokerage_equity_options: response.data?.brokerage_equity_options,
        brokerage_currency_futures: response.data?.brokerage_currency_futures,
        brokerage_currency_options: response.data?.brokerage_currency_options,
        brokerage_commodity: response.data?.brokerage_commodity,
        other_info_company_logo: response.data?.other_info_company_logo,
        other_info_fav_icon: response.data?.other_info_fav_icon,
        other_info_nifty_page_url: response.data?.other_info_nifty_page_url,
        other_info_slug_url: response.data?.other_info_slug_url,
        account_opening_cost_trading_only: response.data?.account_opening_cost_trading_only,
        account_opening_cost_trading_demat: response.data?.account_opening_cost_trading_demat,
        account_opening_cost_commodity: response.data?.account_opening_cost_commodity,
        transparency_other_cost_equity: response.data?.transparency_other_cost_equity,
        transparency_other_cost_futures: response.data?.transparency_other_cost_futures,
        transparency_other_cost_options: response.data?.transparency_other_cost_options,
        transparency_other_cost_commodities: response.data?.transparency_other_cost_commodities,
        transparency_other_cost_amc_charge: response.data?.transparency_other_cost_amc_charge,
        transparency_other_cost_dp_transaction_charge: response.data?.transparency_other_cost_dp_transaction_charge,
        transparency_other_cost_offline_order_place_charge:
          response.data?.transparency_other_cost_offline_order_place_charge,
        platform_software: response.data?.platform_software,
        platform_mobile: response.data?.platform_mobile,
        platform_web_html: response.data?.platform_web_html,
        charting_intraday: response.data?.charting_intraday,
        charting_end_of_day: response.data?.charting_end_of_day,
        charting_coding_backtesting: response.data?.charting_coding_backtesting,
        reporting_trade_reports: response.data?.reporting_trade_reports,
        reporting_pnl_reports: response.data?.reporting_pnl_reports,
        reporting_contract_notes: response.data?.reporting_contract_notes,
        margin_equity: response.data?.margin_equity,
        margin_equity_futures: response.data?.margin_equity_futures,
        margin_equity_options: response.data?.margin_equity_options,
        margin_currency_futures: response.data?.margin_currency_futures,
        margin_currency_options: response.data?.margin_currency_options,
        margin_commodities: response.data?.margin_commodities,
        support_research_tips: response.data?.support_research_tips,
        support_brokerage_calculator: response.data?.support_brokerage_calculator,
        support_margin_calculator: response.data?.support_margin_calculator,
        support_bracket_order_trailing: response.data?.support_bracket_order_trailing,
        support_training_education: response.data?.support_training_education,
        convenience_account_3in_1: response.data?.convenience_account_3in_1,
        convenience_instant_fund_withdrawal: response.data?.convenience_instant_fund_withdrawal,
        convenience_relationship_managers: response.data?.convenience_relationship_managers,
        equity_option_equity: response.data?.equity_option_equity,
        equity_option_equity_futures: response.data?.equity_option_equity_futures,
        equity_option_equity_options: response.data?.equity_option_equity_options,
        equity_option_currency_futures: response.data?.equity_option_currency_futures,
        equity_option_currency_options: response.data?.equity_option_currency_options,
        equity_option_commodity: response.data?.equity_option_commodity,
        broker_service_type: response.data?.broker_service_type,
        broker_account_opening_charge: response.data?.broker_account_opening_charge,
        broker_account_maintain_charge: response.data?.broker_account_maintain_charge,
        broker_equity_delivery_brokerage: response.data?.broker_equity_delivery_brokerage,
        broker_equity_intraday_brokerage: response.data?.broker_equity_intraday_brokerage,
        broker_trade_description: response.data?.broker_trade_description,
        broker_theme_color: response.data?.broker_theme_color,
        top5_web_affiliate_link: response.data?.top5_web_affiliate_link,
        top5_web_sequence: response.data?.top5_web_sequence,
        top5_web_is_active: response.data?.top5_web_is_active,
        top5_app_affiliate_link: response.data?.top5_app_affiliate_link,
        top5_app_sequence: response.data?.top5_app_sequence,
        top5_app_is_active: response.data?.top5_app_is_active,
        top_broker_web_affiliate_link: response.data?.top_broker_web_affiliate_link,
        top_broker_web_sequence: response.data?.top_broker_web_sequence,
        top_broker_web_is_active: response.data?.top_broker_web_is_active,
      };
          ...
          <Card className="mt-3">
            <Card.Body>
              <Form>
                <Row>
                  <Col>
                    <h5 className="fw-500 ps-2">Edit Broker</h5>
                  </Col>
                    ...
                    <Tabs defaultActiveKey="Overview" id="uncontrolled-tab-example" className="mb-0">
                      <Tab eventKey="Overview" className="ps-2" title="Overview">
                        ...
                        <Row>
                          <Col>
                            ...
                            <p className="mt-2 fs-14"> {formValues.other_info_company_logo}</p>
                          </Col>
                          <Col>
                            <Form.Group className="mb-2">
                              ...
                              <Form.Control
                                ...
                                onChange={handleChange}
                              />
                              <p className="mt-2 fs-14"> {formValues.other_info_fav_icon}</p>
                            </Form.Group>
                          </Col>
                          <Col>
                            <Form.Group className="mb-2">
                      ...
                      <Tab eventKey="Features" className="ps-2" title="Features">
                        ...
                        <Row className='align-items-center'>
                          ...
                          <Col lg={3}>
                            <Form.Group as={Row} className="ms-4 mt-4">
                              <Col lg={1} className="mt-0 p-0">
                                <input
                                  className='ms-3'
                                  type="checkbox"
                        ...
                        <Row className=' align-items-center'>
                          ...
                          <Col lg={4}>
                            <Form.Group as={Row} className="mb-2 ms-4">
                              <Col lg={1} className="mt-0 p-0">
                                <input
                                  className='ms-3'
                                  type="checkbox"
                ...
                <Row>
                  <Col className='mt-2'>
                    <Button variant="light" onClick={() => setShow(false)} className="me-2">
                      Close
                    </Button>
